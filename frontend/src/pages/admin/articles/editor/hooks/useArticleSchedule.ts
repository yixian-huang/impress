...
export function useArticleSchedule(opts: {
  ...
  setArticleStatus: (s: "draft" | "published" | "scheduled") => void;
  ...
  const handleSchedulePublish = useCallback(
    ...
    [
      canPublish, zhTitle, slug, setSlug, buildPayload, scheduledPublication,
      id, isEditing, setArticleStatus, articleStatus, navigate, setError,
    ],
  );
